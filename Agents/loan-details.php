                                    ...
                                    <?php if ($loan['status'] == 'approved' || $loan['status'] == 'active'): ?>
                                        <form method="POST" action="loan-details.php?id=<?php echo $loan_id; ?>">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" step="0.01" class="form-control" name="amount_paid" id="amount_paid" value="<?php echo number_format(($is_monthly_interest && $pending_interest_due > 0) ? $pending_interest_due : $loan['monthly_installment'], 2, '.', ''); ?>" required>
                                                <?php if ($is_monthly_interest): ?>
                                                    <small class="form-text text-muted">Monthly Interest: ₹<?php echo number_format($loan['monthly_installment'], 2); ?> | Pending Interest Due: ₹<?php echo number_format($pending_interest_due, 2); ?> (<?php echo $pending_emis_count; ?> EMI<?php echo $pending_emis_count == 1 ? '' : 's'; ?>)</small>
                                                <?php endif; ?>
                                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                     ...
                                     <ul class="list-group list-group-flush mb-3">
                                         ...
                                         <?php else: ?>
                                             <li class="list-group-item d-flex justify-content-between text-success"><span><strong>Total Paid:</strong></span> <span>₹<?php echo number_format($total_paid, 2); ?></span></li>
