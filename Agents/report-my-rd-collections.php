...
$sql = "SELECT
        ...
        WHERE rdp.collected_by_agent_id = ?"; // Filter by the logged-in agent
...
if (!empty($filter_start_date) && !empty($filter_end_date)) {
    $conditions[] = "rdp.payment_date BETWEEN ? AND ?";
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="row g-3" method="GET" action="report-my-rd-collections.php">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <a href="report-my-rd-collections.php" class="btn btn-secondary">Reset</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <h5 class="mb-0">RD Collection Details</h5>
                                        <div class="text-end">
                                            <small class="text-muted d-block">Total RD Collection for Period</small>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <?php if (empty($rd_payments)): ?>
                                                    <tr><td colspan="5" class="text-center text-muted">No RD collections found for the selected criteria.</td></tr>
                                                <?php else: ?>
                                                    <?php foreach ($rd_payments as $payment): ?>
                                                        <tr>
                                                            <td><?php echo date('d M Y, h:i A', strtotime($payment['payment_date'])); ?></td>
                                                            <td><?php echo htmlspecialchars($payment['customer_name']); ?></td>
                                                            <td><a href="rd-details.php?id=<?php echo $payment['rd_id']; ?>">#<?php echo $payment['rd_id']; ?></a></td>
