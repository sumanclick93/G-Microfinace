...
// 1. Authentication Check: Ensure a collection agent is logged in
...
$page_title = "My Customers Loans";
if ($target_loan_type === 'standard') {
    $page_title = "Normal Loans";
} elseif ($target_loan_type === 'interest_only') {
    $page_title = "Interest Loans";
} elseif ($target_loan_type === 'gold') {
    $page_title = "Gold Loans";
}
                                    ...
                                    <div class="card mb-4">
                                        <div class="card-body">
                                            ...
                                            <form class="row g-3" method="GET" action="<?php echo htmlspecialchars($current_page_file); ?>">
                                                ...
                                                <?php endif; ?>
                                                <div class="col-md-<?php echo $preset_loan_type ? '4' : '2'; ?>">
