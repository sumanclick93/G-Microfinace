...
// 4. Loan Type Breakdown Metrics (Standard, Interest-Only, Gold Loan)
// Standard Loans
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mb-4">
                            ...
                            <div class="row g-3">
                                 ...
                                 <div class="col-lg-3 col-md-6"><div class="card card-body text-center h-100 shadow-sm border-0"><h6 class="text-muted">Active Loans</h6><h2><?php echo $active_loans_count; ?></h2></div></div>
                                 <div class="col-lg-3 col-md-6"><div class="card card-body text-center h-100 shadow-sm border-0"><h6 class="text-muted">Average Loan Amount</h6><h2>₹<?php echo number_format($avg_loan_amount); ?></h2></div></div>
                                 ...
                                 <div class="col-lg-3 col-md-6"><div class="card card-body text-center h-100 shadow-sm border-0"><h6 class="text-muted">Total Defaulter Accounts</h6><h2 class="text-danger"><?php echo $default_accounts_count; ?></h2></div></div>
                                 <div class="col-lg-3 col-md-6"><div class="card card-body text-center h-100 shadow-sm border-0"><h6 class="text-muted">Total Default Amount</h6><h2 class="text-danger">₹<?php echo number_format($total_default_amount); ?></h2></div></div>
                            </div>
                        </div>
