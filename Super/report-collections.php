...
$sql = "SELECT 
        ...
        JOIN agents ag ON p.collected_by_agent_id = ag.id
...
if (!empty($filter_agent_id)) {
    $sql .= " AND p.collected_by_agent_id = ?";
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="row g-3" method="GET" action="report-collections.php">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <a href="report-collections.php" class="btn btn-secondary">Reset</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <?php if (empty($payments)): ?>
                                                    <tr><td colspan="6" class="text-center text-muted">No collections found for the selected criteria.</td></tr>
                                                <?php else: ?>
                                                    <?php foreach ($payments as $payment): ?>
                                                        <tr>
                                                            <td><?php echo date('d M Y, h:i A', strtotime($payment['payment_date'])); ?></td>
                                                            <td><?php echo htmlspecialchars($payment['customer_name']); ?></td>
                                                            <td><?php echo htmlspecialchars($payment['agent_first_name'] . ' ' . $payment['agent_last_name']); ?></td>
                                                            <td><a href="admin-loan-details.php?id=<?php echo $payment['loan_id']; ?>">#<?php echo $payment['loan_id']; ?></a></td>
